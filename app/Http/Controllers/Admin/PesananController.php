...
class PesananController extends Controller
{
    ...
    {
        return view('admin.pages.pesanan.index-pesanan');
    }
    ...
    {
        return view('admin.pages.pesanan.create-pesanan');
    }
    ...
    {
        return view('admin.pages.pesanan.show-pesanan', compact('id'));
    }
    ...
    {
        return view('admin.pages.pesanan.edit-pesanan', compact('id'));
    }
